 ...
 * @since 1.0.0
 */
class Mediclean_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'mediclean';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'mediclean' ), $i ),
...
// Initialize.
$mediclean_footer_widgets = new Mediclean_Footer_Widgets();
