 ...
 */
class Mediclean_Heading_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Mediclean_Message_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Mediclean_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Mediclean_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Mediclean_Dropdown_Sidebars_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Mediclean_Customize_Section_Upsell extends WP_Customize_Section {
